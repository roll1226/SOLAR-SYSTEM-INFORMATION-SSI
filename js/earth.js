...
planetVue.text2 = '<p><img src="../images/planet/life.jpg" alt="生命">最初の生命が誕生したのは約38億年前。地上には強い紫外線が降り注ぎ、火山活動は活発で、陸上は生物が生存するには厳しい環境だったため生命誕生の場は海の中でした。生物の材料となったのはアミノ酸、核酸塩基、糖などの有機物で、これらは原始大気中の二酸化炭素や窒素、水などの無機物に雷の放電、紫外線などのエネルギーが加えられて誕生した。</p>';

planetVue.text3 = '<p><img src="../images/planet/earth3.jpg" alt="磁気圏">地球の核は鉄やニッケルなどの合金でできており、内核が固体、外核が液体となっている。液体の外核のなかで内核が回転運動することによって電流が発生し、地球をひとつの大きな磁石にしていると考えられている。これはダイナモ作用と呼びますが、ダイナモの特徴として磁場の向きが時々反転している。地磁気の南北反転が少なくとも過去数億年にわたって続いてきたことが、地球の岩石に残された残留磁気の測定から分かっている。</p>';

planetVue.text4 = '<p><img src="../images/planet/earth4.jpg" alt="オーロラ">この地磁気は地球を取り巻いて磁気圏を形成しており、地球の大気だけでは防ぎきれない、生物にとって有害な太陽風や宇宙線などをある程度防ぐバリアの役割を果たしている。また、磁気圏が強い太陽風を受けることで磁気嵐が発生し、地球の極地方でオーロラが見られる原因になっている。</p>';
