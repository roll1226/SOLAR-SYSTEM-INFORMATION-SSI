...
planetVue.text1 = '<p><img src="../images/planet/mercury.jpg" alt="水星情報">水星は太陽系でもっとも太陽に近くにある。大気はほとんどないので、表面の温度は昼間は450℃、夜中は-180℃まで下がる。岩石と金属から水星は出来ている。</p>';

planetVue.text2 = '<p><img src="../images/planet/mercury1.jpg" alt="カルロス盆地">水星には大きなクレーターで出来ているカロリス盆地がある。カロリス盆地とは、クレーターのまわりを丸くかこんでいるカロリス山脈という波模様がついている場所のこと。</p>';
...
planetVue.text5 = '<p><img src="../images/planet/bepicolombo.jpg" alt="ロケット">2018年10月20日、JAXAは国際水星探査計画BepiColombo（べピコロンボ）ミッションの水星表面探査機（MPO）及び水星磁気圏探査機「みお」（MMO）を搭載したアリアン5型ロケットを平成30年10月20日（土）22時45分28秒（現地時間）（10月20日（土）10時45分28秒（日本標準時））に、フランス領ギアナのギアナ宇宙センターから打ち上げられた。</p>';
