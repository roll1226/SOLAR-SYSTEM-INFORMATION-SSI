...
planetVue.text1 = '<p><img src="../images/planet/moon.jpg" alt="模様">月は地球の衛星。このことから地球の兄弟星とも呼ばれている。空気や水はなく、昼と夜の温度差がはげしい。月は地球より小さいので、もちろん重力も小さく、地球の約6分の1になる。<br>月の模様でうさぎがオモチをついているように見えますが、世界中ではカニ、本を読む女性、ライオンなどにみ見えている。</p>';
...
planetVue.text4 = '<p><img src="../images/planet/kaguya.jpg" alt="かぐや">「かぐや」は月のまわりを周回しながら15種類の装置を使って月を探査し、月表面の元素組成、鉱物組成、地形、表面付近の地下構造、磁気異常、重力場の観測を全域に行う。これらの観測によって、総合的に月の起源・進化の解明に迫ると期待されており、月の全球地図を作成したり高度データを取得したりしたほか、表と裏で重力場に違いがあることや地下構造に層状構造があること、月の裏側の一部では従来考えられていたよりも最近までマグマ活動があったことなどがわかった。</p>';
